...
module Landing =
    ...
    let Make () = Html.div [
        prop.children [
            ...
            Html.div [
                prop.className [
                    "h-[calc(100vh-64px)] w-full xl:p-4"
                ]
                prop.children [
                    Html.div [
                        prop.style [
                                        ...
                                        prop.children [
                                            ...
                                            Html.div [
                                                ...
                                                prop.children [
                                                    Html.a [
                                                        prop.className [
                                                            "block text-2xl font-bold rounded-lg px-6 py-3 bg-black/10 hover:bg-black/20 focus:bg-black/25 backdrop-filter backdrop-blur-sm a"
                                                        ]
